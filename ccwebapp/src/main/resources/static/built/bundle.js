...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    _createClass(App, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            client({ method: 'GET', path: 'timestamps' }).done(function (response) {
	                _this.setState({ timestamps: response.entity._embedded.timestamps });
	            });
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            return React.createElement(TimestampList, { timestamps: this.state.timestamps });
	        }
	    }]);
	...
	var TimestampList = (function (_React$Component2) {
	    ...
	    function TimestampList() {
	        ...
	        _get(Object.getPrototypeOf(TimestampList.prototype), 'constructor', this).apply(this, arguments);
	    }
	    ...
	    _createClass(TimestampList, [{
	        ...
	        value: function render() {
	            var timestamps = this.props.timestamps.map(function (timestamp) {
	                return React.createElement(Timestamp, { key: timestamp._links.self.href, timestamp: timestamp });
	            });
